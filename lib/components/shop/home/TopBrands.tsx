            ...
            <div className="px-1 md:px-0">
                <div className="flex justify-between items-center">
                    <span className="border-b border-b-[3px] border-[#008ECC] pb-3 text-sm md:text-lg lg:text-xl font-semibold">
                        برترین <span className="text-[#008ECC]">برندهای الکترونیک</span>
                    </span>
                ...
                <SwiperWrapper pagination={{ clickable: true }} dots breakpoints={{
                    ...
                    {topBrands.map((brand, index) => (
                        <SwiperSlide className="py-10" key={index}>
                            <div className="rounded-xl px-4 md:px-0 bg-transparent md:bg-gray-100 cursor-pointer hover:scale-103 transition flex items-center justify-center">
                                <img
                                    src={brand.src}
                                    alt="image"
