...
import { Sending, Camera, AvatarPlaceholder } from '@/assets/common/icons';
  ...
  return (
    <div className="max-w-md mx-auto p-6 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">بروزرسانی پروفایل</h2>
        <p className="text-gray-600 mt-2">اطلاعات شخصی خود را ویرایش کنید</p>
      </div>
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-6">
        <div className="flex flex-col items-center">
          <div className="relative mb-4">
            ...
            <button
              ...
              className="absolute bottom-0 right-0 bg-indigo-600 text-white rounded-full p-2 hover:bg-indigo-700 transition"
            >
              <Camera />
            </button>
            <input
        ...
        <div>
          <button
            ...
            className={`w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''
              }`}
          >
            {isSubmitting ? (
